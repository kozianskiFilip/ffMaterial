...
//print_r ($dataArray);
    ...
    $html .= '<table border="1" style="border: 3px solid black;border-collapse: collapse;text-align:center;font-size:10px;">
		  <tr style="background-color:black;color:#f49e42;text-align:center; ">
  			<th>LP</th>
			<th>DEF</th>
  			<th style="text-align: center;">DEF DESC</th>
  			<th>TIRE CODE</th>
        <th>CTC</th>
  			<th>PRESS</th>
  			<th>CURE DATE</th>
...
$responseArray=array( "CHART" => $dataArray, "TABLE" => $html);
